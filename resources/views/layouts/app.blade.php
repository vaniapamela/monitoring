            ...
            <div>
                ...
                <ul class="space-y-4 text-sm font-bold text-slate-600 list-none p-0">
                    <li class="flex flex-col gap-0.5">
                        ...
                        <a href="https://instagram.com/agromonitor.official" target="_blank" rel="noopener noreferrer" class="hover:text-emerald-500 transition no-underline text-slate-600">
                            agromonitor.official
                        </a>
                    </li>
                    <li class="flex flex-col gap-0.5">
                        <span class="text-[9px] text-slate-400 font-extrabold uppercase tracking-wider">YouTube</span>
                        <a href="https://youtube.com/@agromonitorofficial" target="_blank" rel="noopener noreferrer" class="hover:text-emerald-500 transition no-underline text-slate-600">
                            agromonitorofficial
                        </a>
                    </li>
                    <li class="flex flex-col gap-0.5">
                        <span class="text-[9px] text-slate-400 font-extrabold uppercase tracking-wider">TikTok</span>
                        <a href="https://tiktok.com/@agromonitoroffcial" target="_blank" rel="noopener noreferrer" class="hover:text-emerald-500 transition no-underline text-slate-600">
                            agromonitoroffcial
                        </a>
                    </li>
                    <li class="flex flex-col gap-0.5">
                        <span class="text-[9px] text-slate-400 font-extrabold uppercase tracking-wider">Email Resmi</span>
                        <a href="mailto:agrocorporateo@gmail.com" class="hover:text-emerald-500 transition no-underline text-slate-600">
